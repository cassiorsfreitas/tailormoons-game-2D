...
public class ConstantPosition {
    ...
    public static final int[] PLATFORMS_AMOUNT = {0};
    public static final int[] LADDERS_AMOUNT = {0};
    public static final int[] KEYS_AMOUNT = {0};
    public static final int[] ELEVATORS_AMOUNT = {2};
    ...
    public static final int[][] ELEVATORS = {{20, 370, 10, 30}, {350, 65, 10, 30}};
